// Original implementation courtesy https://github.com/lewissbaker/cppcoro
// Licensed MIT, Copyright (c) Lewis Baker
#ifndef __DONK_PROJECT_DONK_CORE_GENERATOR_H__
#define __DONK_PROJECT_DONK_CORE_GENERATOR_H__
...
class generator_promise {
 public:
  ...
  struct yield_awaiter {
    ...
    reference_type await_resume() const { return p->value(); }
  ...
  yield_awaiter yield_value(std::remove_reference_t<T>& value) noexcept {
...
#endif  // __DONK_PROJECT_DONK_CORE_GENERATOR_H__
